...
export async function execute(interaction: ChatInputCommandInteraction) {
  ...
  try {
    ...
    if (!('bulkDelete' in interaction.channel) || typeof interaction.channel.bulkDelete !== 'function') {
      await interaction.reply({ content: '❌ Bulk delete is not available in this channel type.', ephemeral: true });
      return;
    }
